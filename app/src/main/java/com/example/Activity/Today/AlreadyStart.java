...
public class AlreadyStart extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = (View)inflater.inflate(R.layout.runaway,container,false);
        return view;
    }
...
//        });
     ...
     */
    public void init(){
        listView = (ListView)getView().findViewById(R.id.run_list);//rungway 中的列表
        swipeRefreshLayout = (SwipeRefreshLayout)getView().findViewById(R.id.swiperefreshlayout);//AlreadyStart 中的刷新控件
    }
